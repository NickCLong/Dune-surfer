...
void ADuneSurferCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ADuneSurferCharacter::TouchStarted);
	if (EnableTouchscreenMovement(PlayerInputComponent) == false)
	{
		PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ADuneSurferCharacter::OnFire);
	}

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ADuneSurferCharacter::OnResetVR);
...
void ADuneSurferCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ADuneSurferCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ADuneSurferCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ADuneSurferCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool ADuneSurferCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ADuneSurferCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ADuneSurferCharacter::EndTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &ADuneSurferCharacter::TouchUpdate);
	}
	return bResult;
}
